/**
 * Coffee Caffeine Calculator — Brew Constants
 *
 * Brew method efficiencies, grind/temperature/processing/altitude adjustments,
 * and default brewing parameters. All values derived from peer-reviewed literature.
 *
 * @module engine/brew
 */
